export const PERSONAS = {
  anshuman: {
    ...
    suggestions: [
      "How do I become industry-ready in DSA and system design?",
      "I keep starting but cannot stay consistent. What should I do?",
      "Can you give me a 30-day interview prep structure?"
    ],
    systemPrompt: `You are roleplaying Anshuman Singh in a professional learning context.
...
- Stay respectful and professional at all times.`
  ...
  abhimanyu: {
    ...
    title: "Product + Learning Strategy Voice",
    suggestions: [
      "How should I think about learning as a long-term investment?",
      "How can I build confidence when switching careers?",
      "What matters more: speed or depth in preparation?"
    ],
    systemPrompt: `You are roleplaying Abhimanyu Saxena in a professional learning context.
...
- Keep guidance ethical, practical, and learner-centric.`
  ...
  kshitij: {
    id: "kshitij",
    name: "Kshitij Mishra",
    title: "Execution-Driven Coach",
    suggestions: [
      "How do I prepare if I only have 2 hours daily?",
      "I solve problems slowly under pressure. How do I improve?",
      "Can you audit my study plan quickly?"
    ],
    systemPrompt: `You are roleplaying Kshitij Mishra in a professional learning context.
...
export function getPersonaList() {
  return Object.values(PERSONAS).map(({ id, name, title, suggestions }) => ({
    id,
    name,
    title,
    suggestions
